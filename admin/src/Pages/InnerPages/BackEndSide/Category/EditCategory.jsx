...
const EditCategory = () => {
    ...
    const [categoryName, setCategoryName] = useState(selectedCategoryData?.categoryName);
    const [categoryImage, setCategoryImage] = useState(null);
    const [secondaryCategoryImage, setSecondaryCategoryImage] = useState(null);
    const [previewImage, setPreviewImage] = useState(selectedCategoryData?.categoryImage);
